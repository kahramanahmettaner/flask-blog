...
def delete_previous_picture(image):
    prev_picture = os.path.join(app.root_path, 'static/profile_pics', image)
...
def account():
    ...
    if form.validate_on_submit():
        if form.picture.data:
            ...
            delete_previous_picture(current_user.image)
...
def send_reset_email(user):
    ...
    msg = Message('Password Reset Request', sender='kahdev2023@gmail.com', recipients=[user.email])
